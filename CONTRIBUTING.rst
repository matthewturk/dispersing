...
Ready to contribute? Here's how to set up `dispersing` for local development.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/matthewturk/dispersing/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_dispersing
