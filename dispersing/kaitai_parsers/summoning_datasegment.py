...
class SummoningDatasegment(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(SummoningDatasegment, self).__init__(_io)
    ...
    def _fetch_instances(self):
        pass
        _ = self.character_info
        if hasattr(self, '_m_character_info'):
            pass
            self._m_character_info._fetch_instances()

        _ = self.keywords_table
        if hasattr(self, '_m_keywords_table'):
            pass

        _ = self.keywords_table_ptr
        ...
        if hasattr(self, '_m_npc_info'):
            pass
            for i in range(len(self._m_npc_info)):
                pass
                self._m_npc_info[i]._fetch_instances()


        _ = self.object_template_table
        if hasattr(self, '_m_object_template_table'):
            pass
            for i in range(len(self._m_object_template_table)):
                pass
                self._m_object_template_table[i]._fetch_instances()


        _ = self.object_template_table_count
        if hasattr(self, '_m_object_template_table_count'):
            pass

        _ = self.object_template_table_ptr
        ...
        if hasattr(self, '_m_pc_info'):
            pass
            self._m_pc_info._fetch_instances()

        _ = self.spell_table
        if hasattr(self, '_m_spell_table'):
            pass
            for i in range(len(self._m_spell_table)):
                pass
                self._m_spell_table[i]._fetch_instances()
    ...
    class CharacterAttributes(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(SummoningDatasegment.CharacterAttributes, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._debug = collections.defaultdict(dict)
            self._read()
    ...
    class CharacterPosition(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(SummoningDatasegment.CharacterPosition, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._debug = collections.defaultdict(dict)
            self._read()
    ...
    class CharacterRecord(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(SummoningDatasegment.CharacterRecord, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._debug = collections.defaultdict(dict)
            self._read()
        ...
        def _read(self):
            ...
            for i in range(4):
                ...
                self.magic_levels.append(self._io.read_u1())
            ...
            for i in range(4):
                ...
                self.weapon_levels.append(self._io.read_u1())
            ...
            self.current_magic_level_exp = []
            for i in range(4):
                self._debug['current_magic_level_exp']['arr'].append({'start': self._io.pos()})
                self.current_magic_level_exp.append(self._io.read_u2le())
            ...
            self.next_magic_level_exp = []
            for i in range(4):
                self._debug['next_magic_level_exp']['arr'].append({'start': self._io.pos()})
                self.next_magic_level_exp.append(self._io.read_u2le())
            ...
            self.current_weapon_level_exp = []
            for i in range(4):
                self._debug['current_weapon_level_exp']['arr'].append({'start': self._io.pos()})
                self.current_weapon_level_exp.append(self._io.read_u2le())
            ...
            self.next_weapon_level_exp = []
            for i in range(4):
                self._debug['next_weapon_level_exp']['arr'].append({'start': self._io.pos()})
                self.next_weapon_level_exp.append(self._io.read_u2le())
        ...
        def _fetch_instances(self):
            pass
            for i in range(len(self.magic_levels)):
                pass

            for i in range(len(self.weapon_levels)):
                pass

            for i in range(len(self.current_magic_level_exp)):
                pass

            for i in range(len(self.next_magic_level_exp)):
                pass

            for i in range(len(self.current_weapon_level_exp)):
                pass

            for i in range(len(self.next_weapon_level_exp)):
                pass

            self.current_attributes._fetch_instances()
            self.max_attributes._fetch_instances()
    ...
    class ObjectRecord(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(SummoningDatasegment.ObjectRecord, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._debug = collections.defaultdict(dict)
            self._read()
    ...
    class SpellInfo(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(SummoningDatasegment.SpellInfo, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._debug = collections.defaultdict(dict)
            self._read()
    ...
    def character_info(self):
        ...
        self._io.seek(_pos)
        return getattr(self, '_m_character_info', None)

    @property
    def keywords_table(self):
        if hasattr(self, '_m_keywords_table'):
            return self._m_keywords_table
        ...
        self._io.seek(_pos)
        return getattr(self, '_m_keywords_table', None)

    @property
    def keywords_table_ptr(self):
        if hasattr(self, '_m_keywords_table_ptr'):
            return self._m_keywords_table_ptr
        ...
        self._io.seek(_pos)
        return getattr(self, '_m_keywords_table_ptr', None)

    @property
    def npc_info(self):
        if hasattr(self, '_m_npc_info'):
            return self._m_npc_info
        ...
        for i in range(99):
            ...
            self._m_npc_info.append(SummoningDatasegment.CharacterPosition(self._io, self, self._root))
            self._debug['_m_npc_info']['arr'][i]['end'] = self._io.pos()

        self._debug['_m_npc_info']['end'] = self._io.pos()
        self._io.seek(_pos)
        return getattr(self, '_m_npc_info', None)

    @property
    def object_template_table(self):
        if hasattr(self, '_m_object_template_table'):
            return self._m_object_template_table
    ...
    def object_template_table_count(self):
        ...
        self._io.seek(_pos)
        return getattr(self, '_m_object_template_table_count', None)

    @property
    def object_template_table_ptr(self):
        if hasattr(self, '_m_object_template_table_ptr'):
            return self._m_object_template_table_ptr
        ...
        self._io.seek(_pos)
        return getattr(self, '_m_object_template_table_ptr', None)

    @property
    def pc_info(self):
        if hasattr(self, '_m_pc_info'):
            return self._m_pc_info
        ...
        self._io.seek(_pos)
        return getattr(self, '_m_pc_info', None)

    @property
    def spell_table(self):
        if hasattr(self, '_m_spell_table'):
            return self._m_spell_table
        ...
        for i in range(40):
            ...
            self._m_spell_table.append(SummoningDatasegment.SpellInfo(self._io, self, self._root))
            self._debug['_m_spell_table']['arr'][i]['end'] = self._io.pos()

        self._debug['_m_spell_table']['end'] = self._io.pos()
        self._io.seek(_pos)
        return getattr(self, '_m_spell_table', None)
